...
public class main {
    ...
    public static void main(String[] args) throws miniVanException, paseoException, boletoException, RemoteException, InterruptedException {
        ...
        //fach.insertPaseo("2223", des1, LocalTime.of(15, 0), LocalTime.of(14, 0), 25.99);
       ...
       //fore each se llama esto, lo que hace es basicametne lo mismo que el iterador pero sin tener que creaas instancias
